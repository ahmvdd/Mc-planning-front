      ...
      <div className="overflow-hidden rounded-[28px] border border-white/10 bg-white shadow-2xl shadow-black/50">
        ...
        <div className="bg-gradient-to-r from-indigo-600 to-violet-600 px-8 py-7">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-black tracking-tight text-white">Espace Admin</h1>
              <p className="text-xs text-indigo-100/80">Créez votre organisation</p>
            </div>
          </div>
        </div>
        ...
        <div className="p-7">
          {status.type === "success" ? (
            <div className="space-y-5 text-center">
              ...
              <div>
                <h2 className="text-xl font-black text-slate-900">Bienvenue à bord !</h2>
                <p className="mt-1.5 text-sm text-slate-500">Voici votre code d&apos;organisation — partagez-le avec vos employés.</p>
              </div>

              <button
                onClick={copyCode}
                className="group relative w-full rounded-2xl border-2 border-dashed border-slate-200 bg-slate-50 px-5 py-4 transition-all hover:border-indigo-300 hover:bg-white"
              >
                <p className="font-mono text-2xl font-black tracking-widest text-indigo-600">{orgCode}</p>
              ...
              <Link
                href="/dashboard"
                className="flex w-full items-center justify-center gap-2 rounded-xl bg-indigo-600 py-3.5 text-sm font-bold text-white shadow-lg shadow-indigo-200 transition hover:bg-indigo-700"
              >
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                ...
                className="mt-1 flex w-full items-center justify-center gap-2 rounded-xl bg-indigo-600 py-3.5 text-sm font-bold text-white shadow-lg shadow-indigo-200 transition hover:bg-indigo-700 disabled:opacity-60"
              >
                {status.type === "loading" ? (
