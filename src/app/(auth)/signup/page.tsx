    ...
    <div className="mx-auto w-full max-w-lg">
      <div className="overflow-hidden rounded-[28px] border border-white/10 bg-white shadow-2xl shadow-black/50">
        ...
        <div className="bg-blue-600 px-8 py-8 text-center">
          <div className="mx-auto mb-3 flex h-10 w-10 items-center justify-center rounded-xl bg-white/20 text-lg font-bold text-white">S</div>
          <h1 className="text-2xl font-bold tracking-tight text-white">Créer un compte</h1>
          <p className="mt-1.5 text-sm text-blue-100/80">Choisissez votre type de compte</p>
        </div>
        ...
        <div className="space-y-3 p-6">
          <Link
            href="/signup/admin"
            className="group flex items-center gap-4 rounded-2xl border border-slate-200 bg-white p-5 transition-all hover:border-blue-300 hover:shadow-md hover:shadow-blue-50"
          >
            ...
            <ArrowRight size={16} className="shrink-0 text-slate-300 transition-all group-hover:translate-x-1 group-hover:text-blue-500" />
          </Link>
          ...
          <Link
            ...
            className="group flex items-center gap-4 rounded-2xl border border-slate-200 bg-white p-5 transition-all hover:border-blue-300 hover:shadow-md hover:shadow-blue-50"
          >
            <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-slate-100 text-slate-600 transition-colors group-hover:bg-blue-50 group-hover:text-blue-600">
              <Users size={22} />
            </div>
            <div className="flex-1 min-w-0">
